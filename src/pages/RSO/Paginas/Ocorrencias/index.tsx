...
import TabelaOcorrencia from "../../../../components/TabelaOcorrencias";
...
export default function RSOOcorrencias() {
    ...
    return (
        <Container>  
          ...
          <BotaoCustomizado onClick={handleOpen}>Cadastar Ocorrência</BotaoCustomizado>
          {/* {rsoStore.rso.Abordados.map(abordado=> (
            abordado.nome
          ))} */}
          <TabelaOcorrencia ocorrencia={rsoStore.rso.Ocorrencias}/>
