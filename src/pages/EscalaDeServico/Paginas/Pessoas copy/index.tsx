...
export default function RSOVeiculos() {
    ...
    return (
        <Container>  
          <Titulo>Veiculos Abordados</Titulo>
          <BotaoCustomizado onClick={handleOpen}>Cadastar Veiculo</BotaoCustomizado>
          {/* {rsoStore.rso.Abordados.map(abordado=> (
            abordado.nome
          ))} */}
          <TabelaVeiculos veiculo={rsoStore.rso.Veiculos}/>
